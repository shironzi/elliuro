...
function RateCard(props: { ratingDesc: string; rate: number, name: string }) {
  return (
    <div className='w-1/4 flex flex-col gap-2'>
      ...
      <div className='flex flex-row gap-1'>{props.rate ? <><FaStar color='#FFFF00' /><FaStar color='#FFFF00' /><FaStar color='#FFFF00' /><FaStar color='#FFFF00' /><FaStar color='#FFFF00' /></> : <FaRegStar />}</div>
