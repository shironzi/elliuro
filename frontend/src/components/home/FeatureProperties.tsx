...
function FeatureProperties() {
  return (
    <div className="container mx-auto">
      <h1 className="text-center mb-8 mt-24 font-merriweather tracking-wider text-4xl text-beige-400 border-b-2 border-solid border-beige-400 w-fit mx-auto px-16 pb-2">
        FEATURED PROPERTIES
      </h1>
      <div>
