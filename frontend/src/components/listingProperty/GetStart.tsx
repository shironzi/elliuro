      ...
      <div className="w-fit mx-auto flex items-center">
        ...
        <div className="p-20 max-w-screen-lg flex flex-col gap-32 justify-center">
            <div className="flex flex-col gap-3">
                <h1 className="text-4xl tracking-widest">Unlock the Potential of Your Property with Us</h1>
            ...
            <Link to="property-details" className="mx-auto bg-beige-400 px-11 py-4 font-proximaNova text-xl transition-colors duration-300 ease-in hover:bg-secondary-400">GET STARTED</Link>
        </div>
      </div>
    </div>
  )
